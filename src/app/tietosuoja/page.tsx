...
export const metadata: Metadata = {
  title: 'Tietosuojaseloste — Puhelinvertailu.fi',
  description: 'Puhelinvertailu.fi:n tietosuojaseloste. Kerromme, miten käsittelemme henkilötietojasi.',
    ...
    <div className="py-12 sm:py-16">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <article className="mt-10 prose prose-slate max-w-none">
          ...
          <p>
            Puhelinvertailu.fi kerää seuraavia tietoja palvelun käytöstä:
          </p>
          <ul>
          ...
          <p>
            ...
            tietojen käsittelyä. Ota yhteyttä: info@puhelinvertailu.fi.
          </p>
